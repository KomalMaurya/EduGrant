  ...
  return (
    <div className="border p-6 shadow rounded">
        <div className="flex justify-between items-center">
            <img className="h-8" src={assets.google} alt=""/>
        </div>
        <h4 className="font-medium text-xl mt-2">{scholarship.title}</h4>
        <div className="flex items-center gap-3 text-xs mt-2">
            <span className="bg-emerald-50 border border-emerald-200 px-4 py-1.5 rounded">{scholarship.level}</span>
            <span className="bg-red-50 border border-red-200 px-4 py-1.5 rounded">{scholarship.location}</span>
        </div>
